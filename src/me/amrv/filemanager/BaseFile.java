...
abstract class BaseFile {
	 ...
	 * a file with the path <b>temp/folder/data/file</b> and a section of {@code 2}
	 ...
	 * {@code 2} will return <b>folder/data</b>
	 *
	 * <p>
	 ...
	 * cancel it, except from that this work like {@code delete()}.
	 * <p>
	 ...
	 * {@code deleteOnExit()} except this allows to cancel the operation before the
	 * file gets removed
	 *
	 ...
	 *                    sometimes faster on newer computers due to the use of
	 *                    buffers
	 * @return true if the operation was succesful, false otherwise
	 */
	...
	/**
	 * Protecte method to save the file information, this method gets executed once
